...
import FoundingStory from "../assets/Images/aboutus3.webp";
...
export const About = () => {
  return (
    <div>
      ...
      <section className="mx-auto mt-20 flex w-11/12 items-center max-w-maxContent flex-col justify-between gap-10 text-white">
        <LearningGrid />
        <ContactFormSection />
      </section>
